...
public class ChatProvider extends ContentProvider {
    ...
    public static final String SequenceNumber = "sequence_number";
    ...
    public static final String mimeTypeBase = "vnd.android.cursor/vnd.edu.stevens.cs522.chat.";
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_CREATE_MESSAGES =
                "CREATE TABLE " + MESSAGES_TABLE + " ("
                        ...
                        + Longitude + " double not null, "
                        + Text + " text, "
                        + "FOREIGN KEY(" + SenderID + ") references " + PEERS_TABLE + "(" + ID + "));";

        private static final String DATABASE_CREATE_MESSAGES_PEER_INDEX =
                "CREATE INDEX " + MessagesPeerIndex + " ON " + MESSAGES_TABLE + "(" + SenderID + ");";
        ...
        public void deleteAllEntries(SQLiteDatabase db, String table){
    ...
    public void deleteAllPeers(){
        dbHelper.deleteAllEntries(dbHelper.getWritableDatabase(), PEERS_TABLE);
    }
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                ...
                if(row > 0){
                    ...
                    Uri peerUri = PeerContract.CONTENT_URI(values.getAsLong(ChatProvider.SenderID));
            ...
            case PEERS_ALL_ROWS:
                // Make sure to notify any observers
                String[] projection = {ChatProvider.ID, ChatProvider.Name, ChatProvider.Timestamp, ChatProvider.Latitude, ChatProvider.Longitude};
